...
class Data_teknisi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->views('content/pegawai/Admin/crud/data_teknisi', $data);
    }
    ...
    public function edit($tm_pegawai_id)
    {
        ...
        $this->template->views('content/pegawai/Admin/crud/edit_teknisi', $data);
    }
    ...
    public function tambah()
    {
        ...
        $this->template->views('content/pegawai/Admin/crud/tambah_teknisi', $data);
    }
    ...
    public function tambah2()
    {
        ...
        $this->template->views('content/pegawai/Admin/crud/tambah_teknisi2', $data);
    }
}
