...
class Data_dosen extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->views('content/pegawai/Admin/crud/data_dosen', $data);
    }
    ...
    public function edit($tm_pegawai_id)
    {
        ...
        $this->template->views('content/pegawai/Admin/crud/edit_dosen', $data);
    ...
    public function input()
    {
        ...
        if ($_FILES['foto']['name']); {
            if ($this->upload->do_upload('foto')) {
                ...
                redirect('Admin/DataPegawai/Data_dosen/tambah2'); //jika berhasil maka akan ditampilkan view upload
            } else {
                //pesan yang muncul jika terdapat error dimasukkan pada session flashdata
                $this->session->set_flashdata("pesan", "<div class=\"col-md-12\"><div class=\"alert alert-danger\" id=\"alert\">Gagal upload gambar !!</div></div>");
                redirect('Admin/DataPegawai/Data_dosen/tambah'); //jika gagal maka akan ditampilkan form upload
            }
        }
    }
    ...
    public function tambah()
    {
        ...
        $this->template->views('content/pegawai/Admin/crud/tambah_dosen', $data);
    }
    ...
    public function tambah2()
    {
        ...
        $this->template->views('content/pegawai/Admin/crud/tambah_dosen2', $data);
