      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="card card-primary">
            ...
            <form class="user" action="<?php echo base_url('Admin/DataPegawai/Data_admin/input2'); ?>" method="post">
              <div class="card-body">
                ...
                <div class="form-group">
                  <input type="hidden" class="form-control form-control-user" id="tm_user_access_id" name="tm_user_access_id" placeholder="Masukkan User Acces Id" value="1" require>
                </div>
