            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <form class="user" action="<?php echo base_url('Admin/DataMahasiswa/Data_mhs/input2'); ?>" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <input type="hidden" class="form-control form-control-user" id="tm_user_access_id" name="tm_user_access_id" placeholder="Masukkan User Acces Id" value="2" require>
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Pegawai ID</label>

                                    <input type="text" class="form-control form-control-user" id="tm_mahasiswa_id" name="tm_mahasiswa_id" placeholder="Masukkan ID.." value="<?php echo $tm_mahasiswa; ?>" require>
