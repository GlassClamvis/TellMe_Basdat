                    ...
                    <div class="card bg-light mb-3">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" role="form"
                                action="<?= base_url('admin/quiz/add'); ?>" method="post">
                                ...
                                <div class="form-layout-footer">
                                    <button type="submit" class="btn btn-primary bd-0">Tambah Quiz</button>
