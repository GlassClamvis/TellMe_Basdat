<footer class="main-footer">
    <strong>Teaching Learning &copy; 2020-2021 <a href="http://adminlte.io">Tellme Basdat</a>.</strong>
    All rights reserved.
...
<script>
    $(function() {
        $("#datepicker_topik").datetimepicker({
            dateFormat: "yy-mm-dd ",
        });
    });
</script>
<script>
    $(function() {
        $("#datepicker_subtopik").datetimepicker({
            dateFormat: "yy-mm-dd  ",
        });
    });
</script>
