        ...
        <div class="row">
            ...
            <div class="col-md-4 text-md-right">
                <!-- <p class="text-70 brand justify-content-md-end">
                    <img class="brand-icon" src="<?php echo base_url('assets/tealdark/images/logo/item.png')?>" width="100" alt="Tutorio"> Tell Me Basdat
                </p>
                <p class="text-muted mb-0 mb-lg-16pt">Tellme Basdat adalah platform pembelajaran online yang membantu Mahasiswa Dalam Pembelajaran Matakuliah Database</p> -->
            </div>
        </div>
    </div>
    <!-- <div>
        <a href="http://instagram.com/assets/tealdark/images/logo/item.png"><img style="margin:5px" src="[path to your icon]" width="30" height="30" alt="Instagram"></a>
        <a href="http://facebook.com/username"><img style="margin:5px" src="[path to your icon]" width="30" height="30" alt="Facebook"></a>
        <a href="http://youtube.com/user/username" ><img style="margin:5px" src="[path to your icon]" width="30" height="30" alt="YouTube"></a>
    </div> -->
...
<div class="container">
    ...
    <ul class="nav navbar-nav flex-nowrap">
        ...
        <li class="nav-item dropup">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Program Studi</a>
            <div class="dropdown-menu">
