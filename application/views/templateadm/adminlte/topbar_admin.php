    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-dark navbar-light">
            ...
            <li class="nav-item dropdown no-arrow">
                ...
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Hello, <?= $pegawai['tm_pegawai_nama']; ?> &nbsp; <img class="img-circle" src="<?= base_url() ?>upload/<?= $pegawai['tm_pegawai_foto']; ?>" width="25px" height="25px"></span>
